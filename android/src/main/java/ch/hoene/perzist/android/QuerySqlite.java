...
import ch.hoene.perzist.framework.filter.FilterVisitorGenerified;
import ch.hoene.perzist.framework.filter.NotFilter;
import ch.hoene.perzist.framework.filter.Operator;
import ch.hoene.perzist.framework.mapping.Mapping;
import ch.hoene.perzist.framework.query.Query;
